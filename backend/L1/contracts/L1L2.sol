...
contract L1L2 {
    ...
    */
    ...
    function depositUSDC(uint256 amount, uint256 user) public {
        uint256 balance0 = _fakeUSD.balanceOf(address(this));
        _fakeUSD.transferFrom(msg.sender, address(this), amount);
        uint256 balance1 = _fakeUSD.balanceOf(address(this));
    ...
    function withdrawUSDC(uint256 amount, uint256 user) external {
        ...
        _fakeUSD.transfer(msg.sender, amount);
        userBalances[user] -= amount;
    }
